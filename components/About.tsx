...
export default function About() {
  return (
    <section id="studio" className="relative bg-ink">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-20 sm:px-6 sm:py-28 md:grid-cols-2 md:gap-16 md:px-10 md:py-36">
        <Reveal variant="fade">
          <div className="relative h-[300px] overflow-hidden border border-hairline-soft sm:h-[420px] md:h-full">
            <Image
                src={img_src}
              // src="https://images.unsplash.com/photo-1554774853-b414df3aa06c?q=80&w=1400&auto=format&fit=crop"
